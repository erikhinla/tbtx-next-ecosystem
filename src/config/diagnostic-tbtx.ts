...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "We have a system but it is not always followed", value: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Several, but they are not connected", value: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "We manage but it is painful", value: 1 },
...
export const scoringBands: ProfileBand[] = [
  {
    ...
    max: 24,
    profile: "FRAGMENTED",
    description: "Your business is running on effort, not infrastructure. Every project starts fresh. Context gets lost. Decisions repeat. Leads fall through gaps. The fog is thick, and it is costing you time, momentum, and revenue you cannot see clearly. This is not a talent problem. It is a systems problem.",
  ...
  },
  {
    ...
    max: 49,
    profile: "STALLED",
    description: "You have pieces of a system but they are not connected. Tools are running. Some workflows exist. But there is no unified operating layer holding everything together. Execution is inconsistent. Context gets lost between handoffs. AI is adding activity without adding leverage.",
  ...
  },
  {
    ...
    max: 74,
    profile: "SCALING",
    description: "You have real infrastructure. The question now is whether it compounds. You are operating with systems, but the learning loop is incomplete. Work completes without creating retained intelligence. Agents or automations run without governance. The execution layer is not yet recursive.",
  ...
  },
  {
    ...
    max: 100,
    profile: "COMPOUNDING",
    description: "Your operating system is working. Now it needs to scale. You have context, routing, memory, and execution discipline. The next layer is governance, recursive improvement, and an orchestration system that gets sharper every cycle.",
