...
export const COMMAND_CENTER_FILES: CommandCenterFileCard[] = [
  { name: "TBTX_MASTER.md", path: "TBTX_COMMAND_CENTER/TBTX_MASTER.md", href: "/tbtx/hub", role: "Single authoritative operating book across all brands, canons, and rules.", category: "Core" },
  { name: "00_LOCK", path: "TBTX_COMMAND_CENTER/Campaign elements/00_LOCK/", href: "/tbtx", role: "Canonical locks for typography, Start Here CTA, naming, and decisions.", category: "Core" },
  { name: "00_START_HERE", path: "TBTX_COMMAND_CENTER/Campaign elements/00_START_HERE/", href: "/tbtx", role: "Authoritative paths, one-person workflows, and ingestion maps.", category: "Core" },
  { name: "01_CANON", path: "TBTX_COMMAND_CENTER/Campaign elements/01_CANON/", href: "/downloads/The-Architecture-of-AI-Native-Operations.pdf", role: "Source canonical documents and historical reference versions.", category: "Core" },
  { name: "01_MOTION", path: "TBTX_COMMAND_CENTER/Campaign elements/01_MOTION/", href: "https://9s35ujeqbjjbd1bt.public.blob.vercel-storage.com/media/fog-free-share.mp4", role: "Motion probes, layout gifs, and typography animation files.", category: "Creative & Motion" },
  { name: "02_CREATIVE", path: "TBTX_COMMAND_CENTER/Campaign elements/02_CREATIVE/", href: "/media/hero-site-827.jpg", role: "Visual media selects, posters, hero films, and department stills.", category: "Creative & Motion" },
  { name: "03_CAMPAIGN", path: "TBTX_COMMAND_CENTER/Campaign elements/03_CAMPAIGN/", href: "/tbtx", role: "Launch journeys, copy libraries, and conversion sequences.", category: "Creative & Motion" },
  { name: "04_WEBSITE", path: "TBTX_COMMAND_CENTER/Campaign elements/04_WEBSITE/", href: "https://github.com/erikhinla/tbtx-next-ecosystem", role: "Next.js production web application and diagnostic engine.", category: "Code & Runtime" },
  { name: "05_POSTIZ_PACKAGES", path: "TBTX_COMMAND_CENTER/Campaign elements/05_POSTIZ_PACKAGES/", href: "/tbtx/hub", role: "Social media draft packages and Postiz distribution wiring.", category: "Code & Runtime" },
  { name: "06_RUNTIME", path: "TBTX_COMMAND_CENTER/Campaign elements/06_RUNTIME/", href: "/bbai", role: "Governed execution runtime, scripts, and agent environments.", category: "Code & Runtime" },
  { name: "99_ARCHIVE", path: "TBTX_COMMAND_CENTER/99_ARCHIVE/", href: "/downloads/Fog-Lift-Kit.pdf", role: "Frozen pre-lock archives, historical drafts, and consolidated files.", category: "Archive" },
  { name: "Digital De-Fog Daily.pdf", path: "public/downloads/Fog-Free-Daily.pdf", href: "/downloads/Fog-Free-Daily.pdf", role: "Personal 20-minute clearing ritual. Live download.", category: "Live" },
  { name: "Architecting AI Flow.pdf", path: "public/downloads/Architecting-AI-Flow.pdf", href: "/downloads/Architecting-AI-Flow.pdf", role: "FLOW execution architecture deck. Live download.", category: "Live" },
  { name: "AI-Native Operations.pdf", path: "public/downloads/The-Architecture-of-AI-Native-Operations.pdf", href: "/downloads/The-Architecture-of-AI-Native-Operations.pdf", role: "Operating model deck. Live download.", category: "Live" },
  { name: "Digital De-Fog Daily film", path: "media/fog-free-share.mp4", href: "https://9s35ujeqbjjbd1bt.public.blob.vercel-storage.com/media/fog-free-share.mp4", role: "Personal offer hero film. Second film after the site hero.", category: "Live" },
];
