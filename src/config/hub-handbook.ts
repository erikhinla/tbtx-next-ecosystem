...
export const DEPARTMENT_MATRIX: DepartmentMatrixItem[] = [
  {
    ...
    irony: "AI created 50 responses. Noah is still the only one who remembers the client's actual goal.",
  },
  {
    dept: "Finance",
    code: "FIN",
    ...
    irony: "Automated billing ran in seconds. Reconciling what broke took three days.",
  },
  {
    dept: "Legal",
    code: "LGL",
    ...
    irony: "The contract draft generated in seconds. Proving who authorized the source took an investigation.",
  },
  {
    dept: "Production",
    code: "PRD",
    ...
    irony: "Twelve AI versions generated by lunch. Nobody knows which one is approved for ship.",
  },
  {
    dept: "Strategy",
    code: "STR",
    ...
    irony: "A thousand synthetic research points. Zero clear operating directions.",
  },
  {
    dept: "Creative",
    code: "CRT",
  ...
  },
  {
    ...
    irony: "Ten platforms running automated micro-experiments. Nobody can trace which channel made the money.",
  },
  {
