...
export default function TBTXHome() {
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      {/* Atmosphere only — muted, no competing copy */}
      ...
      <div className="relative z-10">
        ...
        <section className="border-t border-zinc-800 bg-black/50 backdrop-blur-sm">
        ...
        <section className="border-t border-zinc-800 bg-[#0a0a0a]/90">
        ...
        <section id="spine" className="border-t border-zinc-800 bg-[#0d0d0d]/95">
          <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="border-t border-zinc-800 bg-[#0a0a0a]/95">
