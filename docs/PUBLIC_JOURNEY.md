...
The site continues the AI/human essay. The scan is the first stand. Products are how the stand becomes a day you can live.
...
4. **Stand** (`#tbtx-stand`) — Not a quiz about how you work. A decision. No scan button. Sends to the doors.
...
8. **Name it** — Above Q1: we're not scoring how you work. We're finding the leftover job.
